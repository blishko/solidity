...
bool SMTLib2Context::isDeclared(std::string const& _name, SortPointer const&) const
{
	// TODO: Are multiple names with different sorts allowed?
	return isDeclared(_name);
}
